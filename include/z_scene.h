...
extern u32 Scene_CmdCamList          (int segBase, void* play, SceneCmdEntry* cmd);
...
extern u32 Scene_CmdCollisionHeader  (int segBase, void* play, SceneCmdEntry* cmd);
extern u32 Scene_CmdLightList        (int segBase, void* play, SceneCmdEntry* cmd);
