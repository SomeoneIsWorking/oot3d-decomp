// OoT3D decomp @ 003d713c  name=FUN_003d713c  size=196

void FUN_003d713c(int param_1)

{
  ...
  if (*(short *)(param_1 + 0x2b8) == 0) {
    ...
    iVar5 = FUN_003736fc(*(undefined4 *)(param_1 + 0x310),uVar6,param_1 + 0x1a4);
    if (iVar5 != 0) {
    ...
    func_0x00373500(uRam003d7208,uRam003d7200,uRam003d7204,param_1 + 0x2c);
    if (*(short *)(param_1 + 0x2dc) == 0) {
      if ((2 < *(short *)(param_1 + 0x2c8)) && (*(byte *)(iVar5 + 0xb7) < 0x18)) {
        *(undefined2 *)(param_1 + 0x2c8) = 0;
        *(undefined4 *)(param_1 + 0x2b0) = uRam003d720c;
        *(undefined1 *)(iVar5 + 0x940) = 1;
        return;
      }
      iVar5 = *(int *)(param_1 + 0x124);
