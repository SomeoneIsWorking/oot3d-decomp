// OoT3D decomp @ 0033228c  name=FUN_0033228c  size=748

uint FUN_0033228c(int param_1,uint param_2,int param_3)

{
  ...
  if (((*(ushort *)(param_1 + 0x194) & 0x20) != 0) && (param_3 == 0)) {
  ...
  *(ushort *)(param_1 + 0x192) = *(ushort *)(param_1 + 0x192) | 0x22;
  if ((int)*(short *)(param_1 + 0x18c) == param_2 && param_3 == 0) {
    return 0xffffffff;
  }
