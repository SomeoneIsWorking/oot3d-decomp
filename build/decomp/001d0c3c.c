...

{
  ...
  if (param_2 == 10) {
    ...
    FUN_00371234(fVar2 * fRam001d0cfc,param_3,1);
    fVar2 = (float)VectorSignedToFloat(-(int)*(short *)(param_4 + 0x336),
                                       (byte)(in_fpscr >> 0x15) & 3);
    FUN_003735e8(fVar2 * fVar1,param_3,1);
  }
  else if (param_2 == 0xd) {
    FUN_00371234(*(float *)(param_4 + 0x814) * fRam001d0cfc,param_3,1);
  }
  else if (param_2 == 0xe || param_2 == 0xf) {
    FUN_00371234(*(float *)(param_4 + 0x814) * fRam001d0d00,param_3,1);
  }
  return 0;
}
