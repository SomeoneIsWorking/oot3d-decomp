// OoT3D decomp @ 002df850  name=FUN_002df850  size=2660

int FUN_002df850(int param_1,int param_2,int param_3,uint param_4,int *param_5)

{
  ...
  *(int *)(param_1 + 4) = param_3;
  ...
  if (local_28 != 0) {
    do {
      uVar11 = FUN_004c0ab0(param_2,iVar3);
      local_38 = (int)uVar11;
...
LAB_002df960:
          ...
          if (*(char *)(param_1 + 0x28) != '\0') goto LAB_002df960;
      ...
      *(int *)(param_1 + 4) = iVar3;
      ...
      case 9:
        ...
        break;
      case 10:
        (**(code **)(*param_5 + 0x38))(param_5,*(uint *)(param_2 + 8) & 0xff,DAT_002e03a8);
        iVar3 = 2;
        *(undefined4 *)(param_1 + 0x20) = 2;
        goto LAB_002e0348;
      case 0xb:
      ...
      case 0x1a:
        ...
        if (DAT_002e03a8 <= local_4c) {
          local_4c = 0xffffffff;
        }
        if (DAT_002e03a8 <= local_48) {
          local_48 = 0xffffffff;
        }
      ...
      case 0x21:
        ...
        if (bVar10 && cVar1 != '\0') goto LAB_002e02d8;
        break;
      case 0x22:
...
LAB_002e0350:
    ...
    if (local_3c != 0) goto LAB_002e0374;
  }
