...

{
  ...
  if (param_3 == 5) {
    ...
    FUN_002d4d34(param_2 + 1,param_2 + 0x83,0,0x23,1,4);
    FUN_002d4d34(param_2 + 1,param_2 + 0x83,2,0x24,1,5);
    FUN_002d5468(param_2 + 1,8,9,0,0);
    FUN_002d5124(iVar3,param_2 + 0x83,2,0,0x20);
    FUN_002d4f10(iVar3,param_2 + 0x83,0,4);
    FUN_002d50e8(iVar3,8,9,0,0);
    return;
  }
  if (param_3 < 6) {
    if (param_3 == 0) {
      FUN_002d5124(iVar3,param_2 + 0x83,2,0,0x20);
      FUN_002d4f10(iVar3,param_2 + 0x83,0,4);
      FUN_002d50e8(iVar3,0,0,*(undefined1 *)(unaff_r5 + 0x13),0);
      return;
    }
    if (param_3 != 1) {
      if (param_3 == 3) {
        ...
        FUN_002d4d34(param_2 + 1,param_2 + 0x83,0,0x23,1,4);
        FUN_002d4d34(param_2 + 1,param_2 + 0x83,2,0x24,1,5);
        FUN_002d5468(param_2 + 1,6,6,0,0);
        FUN_002d5124(iVar3,param_2 + 0x83,2,0,0x20);
        FUN_002d4f10(iVar3,param_2 + 0x83,0,4);
        FUN_002d50e8(iVar3,6,6,0,0);
        return;
      }
      if (param_3 != 4) {
        return;
    ...
    if (param_3 == 0x1d) {
      FUN_002d56e0(param_2 + 1,param_2 + 0x83,*(undefined4 *)(pcVar8 + 0x44),
                   *(undefined4 *)(pcVar8 + 0x48),*(undefined4 *)(pcVar8 + 0x4c));
      FUN_002d5468(param_2 + 1,0,0,0,0);
      FUN_002d5124(iVar3,param_2 + 0x83,1,0,8);
      FUN_002d50e8(iVar3,0,0,0,0);
    }
    return;
  }
  iVar5 = 0;
...
code_r0x002e4a7c:
      ...
      if (param_3 == 1) {
        FUN_002d4d34(param_2 + 1,param_2 + 0x83,0,0x23,1,4);
        FUN_002d4d34(param_2 + 1,param_2 + 0x83,2,0x24,1,5);
        FUN_002d4c30(param_2 + 1,param_2 + 0x83,0,0x22);
        FUN_002d5124(iVar3,param_2 + 0x83,2,0,0x20);
        FUN_002d4f10(iVar3,param_2 + 0x83,0,4);
        FUN_002d50e8(iVar3,uVar9,uVar10,*(undefined1 *)(unaff_r5 + 0x13),0);
      }
        ...
        FUN_002d4d34(param_2 + 1,param_2 + 0x83,0,10,1,1);
        FUN_002d4c30(param_2 + 1,param_2 + 0x83,0,9);
        FUN_002d5124(iVar3,param_2 + 0x83,1,0,8);
        FUN_002d4f10(iVar3,param_2 + 0x83,0,2);
        FUN_002d50e8(iVar3,uVar9,uVar10,*(undefined1 *)(unaff_r5 + 0x13),0);
      }
      FUN_002d5468(param_2 + 1,uVar9,uVar10,*(undefined1 *)(unaff_r5 + 0x13),0);
      return;
    }
  }
