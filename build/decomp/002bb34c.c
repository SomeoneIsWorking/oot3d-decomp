...

{
  ...
  iVar5 = *(int *)(param_1 + 4);
  uVar2 = *(undefined *)(param_1 + 0x81);
  if (iVar5 != 0) {
    iVar5 = FUN_0034807c(iVar5,*(undefined4 *)(param_1 + 0x30));
  }
  FUN_002bd9ec(*(undefined4 *)(param_1 + 0x3c),uVar4,*(undefined4 *)(param_1 + 0x28),iVar5,
               *(undefined *)(param_1 + 0x74),*(undefined4 *)(param_1 + 0x78),uVar2,0);
  fVar3 = DAT_002bb430;
  ...
  if (!SUB41(uVar1 >> 0x1e,0)) {
    ...
    *(float *)(param_1 + 0x34) = fVar6;
    if (fVar3 < fVar6) {
      uVar4 = FUN_00324154(param_2 + 0x3410,param_1);
      FUN_002c3814(*(undefined4 *)(param_1 + 0x34),uVar4,*(undefined *)(param_1 + 0x74),
