...

{
  ...
  if (*(char *)*param_2 == '\0') {
    func_0x00307af4(*(undefined4 *)(param_1 + 0x24),&stack0xffffffe8,0x10);
    return;
  }
  func_0x00409390();
  iVar4 = func_0x00314318(param_2 + 3,0);
  fVar12 = fRam003fa5bc;
  if (-1 < iVar4) {
    uVar5 = func_0x00314318(param_2 + 3,0);
    uVar5 = func_0x0040f74c(*(undefined4 *)(*(int *)(param_1 + 4) + 0x10),uVar5);
    func_0x004003fc(fVar12,auStack_43c,uVar5,1);
    func_0x00408ef8(param_1 + 0x24,0,auStack_43c);
  }
  piVar7 = param_2 + 4;
  iVar4 = 0;
  do {
  ...
  fVar13 = fVar13 * fRam003fa5c0;
  fVar14 = fVar14 * fRam003fa5c0;
  fVar11 = fVar11 * fRam003fa5c0 + fVar8 * fRam003fa5c0 * 0.0;
  fVar8 = fVar12;
  if ((fVar12 <= fVar11) && (fVar8 = fVar11, 0x3f800000 < (int)fVar11)) {
    fVar8 = fRam003fa5c4;
  }
  uVar5 = VectorFloatToUnsigned(fRam003fa5cc + fVar8 * fRam003fa5c8,3);
