// OoT3D decomp @ 002bd118  name=FUN_002bd118  size=124

void FUN_002bd118(undefined4 param_1,int param_2,int param_3,undefined4 param_4)

{
  ...
  FUN_002bd9ec(param_1,uVar2,*(undefined4 *)(param_2 + 0x28),iVar3,*(undefined *)(param_2 + 0x74),
               *(undefined4 *)(param_2 + 0x78),uVar1,0);
  return;
}
