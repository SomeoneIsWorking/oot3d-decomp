...
void FUN_002bd9ec(float param_1,int param_2,undefined4 param_3,int param_4,uint param_5_00,
...

{
  ...
  if (((*(uint *)(DAT_002bdd2c + 4) & 1) == 0) && (iVar4 = FUN_003679b4(DAT_002bdd30), iVar4 != 0))
  {
    FUN_00350820(DAT_002bdd38,DAT_002bdd34,0x24,0x40);
  }
  iVar4 = DAT_002bdd38;
  if (param_4 != 0) {
    *(undefined *)(param_2 + 0x1c) = 0;
    FUN_0048ba78(param_3,iVar4);
    iVar4 = DAT_002bdd4c;
    fVar3 = DAT_002bdd48;
    fVar2 = DAT_002bdd44;
    fVar1 = DAT_002bdd40;
    if (param_6 != 0) {
      param_1 = (float)VectorSignedToFloat((int)(param_1 + DAT_002bdd3c),
    ...
    if (param_5_00 != 0) {
      do {
        if (uVar9 == *(byte *)(*(int *)(param_2 + 4) + 0x75)) {
          FUN_00347550(param_1,param_4,uVar9,DAT_002bdd38 + uVar9 * 0x24);
        }
        else {
          FUN_00347550(param_1,param_4,uVar9,DAT_002bdd38 + uVar9 * 0x24);
        }
        pfVar5 = (float *)(param_5 + uVar9 * 0x34);
        pfVar6 = (float *)(DAT_002bdd38 + uVar9 * 0x24);
        fVar10 = ABS(pfVar6[4] * fVar1);
        in_fpscr = in_fpscr & 0xfffffff | (uint)(fVar2 <= pfVar6[5] * fVar1) << 0x1d;
        fVar11 = ABS(pfVar6[5] * fVar1);
        for (fVar12 = ABS(pfVar6[3] * fVar1); DAT_002bdd50 <= (int)fVar12; fVar12 = fVar12 - fVar3)
        {
        }
        for (; DAT_002bdd50 <= (int)fVar10; fVar10 = fVar10 - fVar3) {
        }
        for (; DAT_002bdd50 <= (int)fVar11; fVar11 = fVar11 - fVar3) {
        }
