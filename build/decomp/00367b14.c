...

{
  ...
  if (param_2 == -1) {
    param_2 = (int)*(short *)(iRam00367bf0 + param_1);
  }
  iVar5 = *(int *)(param_1 + param_2 * 4 + 0xa54);
  iVar2 = func_0x003521f0(iVar5,1,param_3);
  uVar3 = func_0x003521f0(iVar5,2,param_4);
  *(float *)(iVar5 + 0x124) =
  ...
  if (iVar4 == 0) {
    *(undefined4 *)(iVar5 + 0x134) = uRam00367bf4;
  ...
  *(undefined4 *)(iVar5 + 0x148) = uRam00367bf8;
