// OoT3D decomp @ 001da28c  name=FUN_001da28c  size=196

void FUN_001da28c(int param_1,int param_2)

{
  ...
  iVar1 = *(int *)(param_2 + *(short *)(iRam001da350 + param_2) * 4 + 0xa54);
  fVar3 = *(float *)(iVar1 + 0x8c) - *(float *)(param_1 + 0x28);
  fVar2 = *(float *)(iVar1 + 0x94) - *(float *)(param_1 + 0x30);
  FUN_0033d364(SQRT(fVar3 * fVar3 + fVar2 * fVar2),uRam001da354);
  ...
  FUN_0035e240(param_1 + 0x1a4,param_1 + 0x148,uRam001da35c,uRam001da358,param_1,0);
  return;
}
